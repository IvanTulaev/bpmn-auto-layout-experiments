  ...
  if (isBoundary) {
    ...
    if (dX === 0 && dY < 0){
      return [
          ...
          // пока / 4 потом надо разобраться получше
          {x: sourceMid.x, y: sourceMid.y + DEFAULT_CELL_HEIGHT / 4},
          {x: sourceMid.x - DEFAULT_CELL_WIDTH / 2, y: sourceMid.y + DEFAULT_CELL_HEIGHT / 4},
          {x: sourceMid.x - DEFAULT_CELL_WIDTH / 2, y: targetMid.y},
    ...
    if (dX > 0 && dY < 0){
      return [
        ...
        // пока / 4 потом надо разобраться получше
        {x: sourceMid.x, y: sourceMid.y + DEFAULT_CELL_HEIGHT / 4},
        {x: targetMid.x, y: sourceMid.y + DEFAULT_CELL_HEIGHT / 4},
...
/**
 * Расчитывает выходы из вершин
 * @param dY
 * @param dX
 * @param isTarget
 */
function getDocking(dY, dX, isTarget) {
  //12
  // if ()
  //1
  //3
